...
declare -a DOHOSTS=( "do.localhost" "app.do.localhost" "api.do.localhost" "cdn.do.localhost" "www.do.localhost" "www.app.do.localhost" "www.api.do.localhost" "www.cdn.do.localhost" )
