describe('Resource /apps', function () {
  ...
  describe('PUT /apps/:aid/live', function () {
    ...
    it('should return error if not logged in',
      ...
      function (done) {
        ...
        request
          .put('/apps/' + saved.apps.first._id + '/live')
          .send({})
          .expect('Content-Type', /json/)
          .expect(401)
          .end(done);
    ...
    it('should return error if live is not boolean', function (done) {
      ...
      request
        ...
        .expect({
          status: 400,
          error: 'Provide live val as boolean true / false'
        })
        .end(done);
    ...
    it('should update app live mode', function (done) {
